...
test("buildKoIdentityWriterCandidate gives era-manifesto mode a period-scale thesis", () => {
  ...
  assert.match(text, /(국면|질서|시대|체급|사이클|구조)/);
